...
Page({
  data: {
    ...
    multiArray3: [["可选", "宿舍区", "教学区"], []],
    multiArray4: [["可选", "宿舍区", "教学区"], []],
    array: [
      "上午(6:00-11:00)",
      "中午(11:00-14:00)",
      "下午(14:00-19:00)",
  ...
  submit: function () {
    ...
    tt.request({
      url: "http://139.9.86.70:8080/miniapp/addlost", // 目标服务器url
      header: {
  ...
  binMultiPickerColumnChange1: function (e) {
    // return;
  ...
  binMultiPickerColumnChange2: function (e) {
    // return;
    console.log("修改的列为", e.detail.column, "，值为", e.detail.value);
    var data = {
  ...
  binMultiPickerColumnChange3: function (e) {
    // return;
    console.log("修改的列为", e.detail.column, "，值为", e.detail.value);
    var data = {
  ...
  binMultiPickerColumnChange4: function (e) {
    // return;
    console.log("修改的列为", e.detail.column, "，值为", e.detail.value);
    var data = {
